...
public class ForceUpdateChecker {
    ...
    public void getRemoteKeys(){
        ...
        PreferenceHelper.setClientKey(remoteConfig.getString(CLIENT_KEY));
        PreferenceHelper.setApiSecret(remoteConfig.getString(API_SECRET));
        Log.e("CLIENT_KEY "+PreferenceHelper.getClientKey(),"API_SECRET"+PreferenceHelper.getApiSecret());
    }
