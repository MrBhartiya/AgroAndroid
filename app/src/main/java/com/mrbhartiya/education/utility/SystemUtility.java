...
public class SystemUtility extends BroadcastReceiver {
    ...
    public static void showNetworkFailureAlert(Context mContext) {
        ...
        new AlertDialog.Builder(mContext, R.style.AppTheme_AlertDialog)
                .setMessage(mContext.getResources().getString(R.string.network_not_available_mg)).setTitle("")
                .setCancelable(false)
                .setNegativeButton("OK", new DialogInterface.OnClickListener() {
                    @Override
    ...
    public static void showAlertSession(Context context, String title, String message, DialogInterface.OnClickListener okListner, DialogInterface.OnClickListener cancelListner) {
        if (alert != null && alert.isShowing())
            return;
        new AlertDialog.Builder(context, R.style.AppTheme_AlertDialog)
                .setMessage(message)/*.setTitle(title)*/
                .setCancelable(false)
                .setPositiveButton("Yes", okListner)
                .setNegativeButton("No", cancelListner)
                .create();
        alert.show();
    ...
    public static void showOfflineAlert(Context mContext, DialogInterface.OnClickListener onClickListener) {
        ...
        new AlertDialog.Builder(mContext, R.style.AppTheme_AlertDialog)
                ...
                }).setPositiveButton(R.string.str_show_downloads, onClickListener)
                .create()
                .show();
